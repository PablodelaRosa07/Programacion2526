...
while opcion == "T" or opcion == "J":
    if opcion == "T":
        ...
        while MinasEncontradas < numMinas and numIntentos < intentos:
        ...
        print(f"Has encontrado {MinasEncontradas} minas de las {numMinas} que habían. La puntuación final es {puntos} puntos")
        print("---FIN DEL JUEGO---")
    print("Pulse T para generar un nuevo tablero")
    print("Pulse J para jugar")
    print("Pulse E para salir del juego")
